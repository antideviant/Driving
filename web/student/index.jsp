                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-6 col-6">
                        ...
                        <div class="small-box bg-2">
                           <div class="inner">
                              <h3><% out.print(appointmentDAO.countAppointment(student)); %></h3>
                              <p>Enrolled Appointments</p>
                           </div>
                           <div class="icon">
                              <i class="fa fa-book fa-2x"></i>
                           </div>
                           <a href="manage-appointment.jsp" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                     </div>
                  </div>
                  <!-- /.row -->
