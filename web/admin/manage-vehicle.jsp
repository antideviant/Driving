                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6 animated bounceInRight">
                                <h1 class="m-0"><span class="fa fa-user"></span> Vehicle List</h1>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                        ...
                        <div class="card-body animated pulse">
                            <table id="example1" class="table table-bordered table-striped">
                               ...
                               for (Vehicle vehicle : vehicles) {%>
                                    <tr>
                                        <td>
                                            <p class="info"><b><% out.print(vehicle.getVehicleID()); %></b></p>
                                        </td>
                                        <td>
                                            <p class="info">Name: <b><% out.print(vehicle.getVehicleName()); %></b></p>
                                            <p class="info"><small>Type: <b><% out.print(vehicle.getVehicleType()); %></b></small></p>
                                            <p class="info"><small>Plat No: <b><% out.print(vehicle.getVehiclePlatNo()); %></b></small></p>
                                        </td>
                                        <td>
                                            <p><b><% out.print(vehicle.getVehicleStatus()); %></b></p>
                                        </td>
                                        <td class="text-right">
                                            <a class="btn btn-sm btn-success" href="edit-vehicle.jsp?id=<% out.print(vehicle.getVehicleID()); %>"><i
                                                    class="fa fa-pen"></i></a>
                                            <a class="btn btn-sm btn-danger" href="../VehicleDeleteServlet?id=<% out.print(vehicle.getVehicleID()); %>" 
