                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6 animated bounceInRight">
                                <h1 class="m-0"><span class="fa fa-plus"></span> Add Vehicle</h1>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                ...
                <section class="content">
                    <div class="container-fluid">
                        <div class="card card-info">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="/Driving/VehicleAddServlet" method="post">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3">
...
<!--                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="vehi_id" class="form-control" placeholder="first name">
                                                    </div>
                                                </div>-->
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="vehi_name" class="form-control" placeholder="Please enter vehicle brand and model name">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Vehicle Plat Number</label>
                                                        <input type="text" name="vehi_platno" class="form-control" placeholder="Please enter vehicle plat number">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
