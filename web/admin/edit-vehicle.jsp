                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6 animated bounceInRight">
                                <h1 class="m-0"><span class="fa fa-plus"></span> Edit Vehicle</h1>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                ...
                <section class="content">
                    <div class="container-fluid">
                        <div class="card card-info">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="/Driving/VehicleUpdateServlet" method="post">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9">
                                            <div class="card-header">
                                                <span class="fa fa-user"> Vehicle Information</span>
                                            </div>
                                            <div class="row">
                                                <input type="hidden" name="vehi_id" value="<% out.print(vehicle.getVehicleID()); %>" class="form-control" readonly>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Vehicle Name</label>
                                                        <input type="text" name="vehi_name" value="<% out.print(vehicle.getVehicleName()); %>" class="form-control" placeholder="name">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="vehi_type">
                                                            <option value="MANUAL" <% if (vehicle.getVehicleType().equals("MANUAL")) { out.print("selected"); } %>>Manual</option>
                                                            <option value="AUTO" <% if (vehicle.getVehicleType().equals("AUTO")) { out.print("selected"); } %>>Auto</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Vehicle Plat No</label>
                                                        <input type="text" name="vehi_platno" value="<% out.print(vehicle.getVehiclePlatNo()); %>" class="form-control" placeholder="plat no">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Vehicle Status</label>
                                                        <select class="form-control" name="vehi_status">
                                                            <option value="AVAILABLE" <% if (vehicle.getVehicleStatus().equals("AVAILABLE")) { out.print("selected"); } %>>Available</option>
                                                            <option value="NOT AVAILABLE" <% if (vehicle.getVehicleStatus().equals("NOT AVAILABLE")) { out.print("selected"); } %>>Not Available</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
