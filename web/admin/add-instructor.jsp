                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6 animated bounceInRight">
                                <h1 class="m-0"><span class="fa fa-plus"></span> Add Instructor</h1>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                ...
                <section class="content">
                    <div class="container-fluid">
                        <div class="card card-info">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="/Driving/InstructorRegisterServlet" method="post">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="inst_name" class="form-control" placeholder="Please enter first name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="inst_phone" class="form-control" placeholder="Please enter contact number">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" name="inst_email" class="form-control" placeholder="Please enter email address">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Password</label>
                                                        <input type="password" name="inst_pass" class="form-control" placeholder="**********">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
