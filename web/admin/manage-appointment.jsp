                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6 animated bounceInRight">
                                <h1 class="m-0"><span class="fa fa-user"></span> Appointment List</h1>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="info">Name: <b><% out.print(appointment.getAppointStudent().getStudName()); %></b></p>
                                            <p class="info"><small>Contact #: <b><% out.print(appointment.getAppointStudent().getStudPhone()); %></b></small></p>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <p class="info">Status: <b><% out.print(appointment.getAppointStatus()); %></b></p>
                                        </td>
                                        <td class="text-right">
                                            <a class="btn btn-sm btn-success" href="edit-appointment.jsp?id=<% out.print(appointment.getAppointID()); %>"><i
                                                    class="fa fa-pen"></i></a>
                                            <a class="btn btn-sm btn-danger" href="../AppointmentDeleteServlet?id=<% out.print(appointment.getAppointID()); %>" 
