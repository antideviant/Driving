     ...
     <div class="container-fluid d-flex flex-row justify-content-center py-5">
      <div class="mx-auto d-inline-block">
         ...
         <div class="card card-outline card-primary">
            ...
            <div class="card-body">
               <br>
               <h3 class="font-weight-bold text-center" style="text-align: left;">
                  Welcome Back, Instructor.
               </h3>
               <br>
               <form action="/Driving/InstructorLoginServlet" method="post">
                  <div class="input-group mb-3">
                     <input type="text" class="form-control" name="inst_email" id="username" placeholder="Please enter your e-mail" required>
                     <div class="input-group-text">
                        <span class="fas fa-envelope"></span>
                     </div>
                  </div>
                  <div class="input-group mb-3">
                     <input type="password" class="form-control" name="inst_pass" id="password" placeholder="Please enter your password" required>
                     <div class="input-group-text">
