...
<%
    ...
    int appointID = (idParam != null) ? Integer.parseInt(idParam) : 0;
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6 animated bounceInRight">
                            <h1 class="m-0"><span class="fa fa-plus"></span> Edit Appointment</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card card-info">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="/Driving/AppointmentUpdateServlet" method="POST">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <input type="hidden" name="appoint_ID" value="<%= appointment.getAppointID() %>">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="stud_id">
                                                        <% for (Student student : students) { %>
                                                            <option value="<%= student.getStudID() %>" <% if(student.getStudID() == appointment.getAppointStudent().getStudID()) { out.print("selected"); } %>>
                                                                <%= student.getStudName() %>
                                                            </option>
                                                        <% } %>
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="inst_id">
                                                        <% for (Instructor instructor : instructors) { %>
                                                            <option value="<%= instructor.getInstID() %>" <% if(instructor.getInstID() == appointment.getAppointInstructor().getInstID()) { out.print("selected"); } %>>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="vehi_id">
                                                        <% for (Vehicle vehicle : vehicles) { %>
                                                            <option value="<%= vehicle.getVehicleID() %>" <% if(vehicle.getVehicleID() == appointment.getAppointVehicle().getVehicleID()) { out.print("selected"); } %>>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="appoint_date" class="form-control" placeholder="date" value="<%= dateFormat.format(appointment.getAppointDate()) %>" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Start Time</label>
                                                    <input type="time" name="appoint_timestart" class="form-control" placeholder="contact" value="<%= appointment.getAppointTimeStart() %>" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">End Time</label>
                                                    <input type="time" name="appoint_timeend" class="form-control" placeholder="email" value="<%= appointment.getAppointTimeEnd() %>" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Appointment Status</label>
                                                    <select class="form-control" name="appoint_status">
                                                        <option value="UPCOMING" <% if(appointment.getAppointStatus().equalsIgnoreCase("UPCOMING")) { out.print("selected"); } %>>UPCOMING</option>
                                                        <option value="ENROLLED" <% if(appointment.getAppointStatus().equalsIgnoreCase("ENROLLED")) { out.print("selected"); } %>>ENROLLED</option>
                                                        <option value="CANCELED" <% if(appointment.getAppointStatus().equalsIgnoreCase("CANCELED")) { out.print("selected"); } %>>CANCELED</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
