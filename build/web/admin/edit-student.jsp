                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="student.jsp">Home</a></li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="license_type" required>
                                                            <option value="D" <% if (student.getLicenseType().equals("D")) { out.print("selected"); } %>>D</option>
                                                            <option value="DA" <% if (student.getLicenseType().equals("DA")) { out.print("selected"); } %>>DA</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="stud_ic" value="<% out.print(student.getStudIC()); %>"  class="form-control" placeholder="IC No" required>
                                                    </div>  
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" name="stud_email" value ="<% out.print(student.getStudEmail()); %>" class="form-control" placeholder="email" required>
                                                    </div>
                                                </div>
                                                ...
                                                <input type="hidden" name="stud_id" value="<% out.print(student.getStudID()); %>" class="form-control" readonly>
                                                <div class="col-md-6">
                                                    <div class="form-group">
