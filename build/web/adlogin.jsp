            ...
            <div class="mx-auto d-inline-block">
                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <form action="/Driving/AdminLoginServlet" method="post">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" name="admin_email" id="username" placeholder="Please enter your e-mail" required>
                                <div class="input-group-text">
                                    <span class="fas fa-envelope"></span>
                                </div>
                            </div>
                            <div class="input-group mb-3">
                                <input type="password" class="form-control" name="admin_pass" id="password" placeholder="Please enter your password" required>
                                <div class="input-group-text">
